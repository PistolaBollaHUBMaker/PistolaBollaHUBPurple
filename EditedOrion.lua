...
local function Hide(notify: boolean?)
	...
	if notify then
		if useMobilePrompt then 
			RayfieldLibrary:Notify({Title = "Interfaccia Nascosta", Content = "L'interfaccia è stata nascosta, puoi mostrarla cliccando 'Mostra'.", Duration = 7, Image = 4400697855})
		else
			RayfieldLibrary:Notify({Title = "Interfaccia Nascosta", Content = "L'interfaccia è stata nascosta, puoi mostrarla cliccando K.", Duration = 7, Image = 4400697855})
		end
	end
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if Settings.LoadingTitle ~= "Rayfield Interface Suite" then
		LoadingFrame.Version.Text = "PistolaBollaHUB"
	end
