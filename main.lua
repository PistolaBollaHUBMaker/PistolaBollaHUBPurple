...
Visualizzatore:AddButton({
 ...
 Callback = function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/PistolaBollaHUBMaker/PistolaBollaHUBPurple/refs/heads/main/visualizer.lua"))()
    end
})
...
Giochi:AddButton({
 Name = "Brookhaven",
 Callback = function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/PistolaBollaHUBMaker/PistolaBollaHUBPurple/refs/heads/main/brookhaven.lua"))()
    end
})
Giochi:AddButton({
 Name = "Tapping Simulator",
 Callback = function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/PistolaBollaHUBMaker/PistolaBollaHUBPurple/refs/heads/main/tap.lua"))()
 end
})
Giochi:AddButton({
 Name = "Rainbow Friends",
 Callback = function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/PistolaBollaHUBMaker/PistolaBollaHUBPurple/refs/heads/main/rainbowfriends.lua"))()
 end
})
Giochi:AddButton({
 Name = "Basically FNF: Remix",
 Callback = function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/PistolaBollaHUBMaker/PistolaBollaHUBPurple/refs/heads/main/bfnf.lua"))()
 end
})
Giochi:AddButton({
