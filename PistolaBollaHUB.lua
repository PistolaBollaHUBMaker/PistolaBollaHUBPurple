...
function PizdaMata()
local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/PistolaBollaHUBMaker/PistolaBollaHUBPurple/main/EditedOrion.lua?')))()
local Window = OrionLib:MakeWindow({Name = "PistolaBollaHUB <font color="#AD00FF"> NEO</font>", HidePremium = false, SaveConfig = true, IntroEnabled = true, IntroIcon = "rbxassetid://17806684890", IntroText = "PistolaBollaHUB", Icon = "rbxassetid://17806684890"})
local Notification = loadstring(game:HttpGet("https://api.irisapp.ca/Scripts/IrisBetterNotifications.lua"))()
